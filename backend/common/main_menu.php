...
<div id='menu'>
    <ul>
        ...
        <li class='has-sub'> <a href='#'> <i class="fa fa-tasks"></i> <span>Lab Manager</span> </a>
            <ul <?= ($type == 'lab') ? 'style="display: block"' : '' ?>>
                <li> <a href='index.php?action=lab_add'
                        <?= ($type == 'lab' && $action == 'add') ? 'class="select"' : '' ?>> <span>Add New User</span> </a> </li>
                <li> <a href='index.php?action=lab_list'
                        <?= ($type == 'lab' && $action == 'list') ? 'class="select"' : '' ?>> <span>List All Users</span> </a> </li>
                <li> <a href='index.php?action=lab_find'
                        <?= ($type == 'lab' && $action == 'find') ? 'class="select"' : '' ?>> <span>Find User</span> </a> </li>
            </ul>
        </li>   
