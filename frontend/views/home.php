                    ...
                    foreach ($value as $key) {
                        ...
                        <div class="col-lg-4" id="<?=$key['device_value']?>">
                            <div class="form-group">
                                ...
                                <div>
                                    <div class="cube-switch3">
                                        <span class="switch3" onclick="switchAir(this);checkAir(this)">
                                            <span class="switch-state3 off3">Off</span>
                                            <span class="switch-state3 on3">On</span>
                                        </span>
                                    </div>
                                ...
                                <div id="air<?=$key['device_value']?>">
                                    ...
                                    <div class="selection">
                                        <select onclick="checkIR(this);">
                                            <option value="0">20&deg;C</option>
                                            <option value="1">22&deg;C</option>
                                            <option value="2">24&deg;C</option>
                                        </select>
                                </div>
                                </div>
            ...
            <div class="col-sm-4 col-md-4 col-lg-4 col-xs-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body warning" id="subscribeCollapse">
                        <div id="container-speed"class="container-speed img-responsive"></div>
                    </div>
                </div>
            </div>
            <div class="col-sm-4 col-md-4 col-lg-4 col-xs-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body warning" id="subscribeCollapse">
                        <img id="lightsensor" src="../pictures/lightoff.png" class="img-responsive">
                    </div>
                </div>
            </div>
            <div class="col-sm-4 col-md-4 col-lg-4 col-xs-12">
